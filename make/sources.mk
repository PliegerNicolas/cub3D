...
SOURCES += ./sources/graphics/draw.c
...
SOURCES += ./sources/graphics/vector2.c
...
SOURCES += ./sources/graphics/weapon/get_weapon_textures.c
...
SOURCES += ./sources/graphics/controls/utils/act_on_camera.c
SOURCES += ./sources/graphics/controls/utils/act_on_displacement.c
SOURCES += ./sources/graphics/controls/utils/act_on_toggle.c
SOURCES += ./sources/graphics/controls/utils/bitmask.c
SOURCES += ./sources/graphics/controls/utils/check_and_move.c
SOURCES += ./sources/graphics/controls/utils/mouse_motion_utils.c
SOURCES += ./sources/graphics/controls/utils/render_type.c
